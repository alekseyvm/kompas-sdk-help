...
[Группа 5: Выделение и выбор](#выделение-и-выбор) | [К оглавлению](#методы-интерфейса)
...
[Группа 6: Параметрические переменные](#параметрические-переменные) | [К оглавлению](#методы-интерфейса)
