...
**Полное описание:** Метод предоставляет доступ к коллекции полных окружностей. Окружности используются для создания круглых отверстий, обозначений и других элементов с радиальной симметрией. В отличие от дуг, окружности всегда представляют полный круг. Коллекция [`ICircles`](../Графические объекты/ICircles.md) позволяет добавлять новые окружности и управлять их параметрами.
